  ...
  return ( 
    <ThemeProvider theme={darkTheme}>
        <Container style={{textAlign: 'center'}}>
            ...
            <TextField label="Search coins..." variant='outlined' style={{marginBottom: 20, width: '100%'}} onChange={(e) =>setSearch(e.target.value)}/>
            <TableContainer>
                {
                    loading? (
                            ...
                            <TableHead style={{backgroundColor: '#EEBC1d'}}>
                                <TableRow>
                                    {["Coin", 'Price', '24h Change', 'Market Cap'].map((head) => (
                                        <TableCell style={{color: 'black',  fontWeight:'700', fontFamily:'Roboto'}} key={head} align={head === 'Coin' ?  '' : 'right'}>
                                            {head}
                                        </TableCell>
                                    ))}
                                </TableRow>
